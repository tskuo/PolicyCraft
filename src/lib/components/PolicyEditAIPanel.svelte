	...
	let messageHistory: any[] =
		cases.size > 0
			? [
					{
						person: 'AI Assistant',
						message: `I am an AI assistant who can help brainstorm ways to improve a policy, based on concrete cases. To begin with, please select a related case below.`
					}
				]
			: [
					{
						person: 'AI Assistant',
						message: `I am an AI assistant who can help brainstorm ways to improve a policy, based on concrete cases. It appears that this policy currently has no related cases. Please first add some related cases that reveal flaws in the policy, so that I can help refine the policy accordingly.`
					}
				];
